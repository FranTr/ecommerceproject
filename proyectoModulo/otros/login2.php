...
<div id="container">
 ...
 <form method="POST" id="login" action="<?php echo $root ?>login/auth.php">
   ...
   <button type = "submit" class="btn btn-lg btn-primary btn-block">Log in</button>
     <button href="../index.php" class="btn btn-lg btn-primary btn-block">Volver a inicio</button>
</form>
</div>
...
<style>
 html { 
  background: url(http://corkandbottle.vn/wp-content/uploads/2015/09/0012_dw_banner2-1140x445.jpg) no-repeat center center fixed; 
